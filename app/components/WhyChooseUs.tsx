    ...
    return (
        <section className="flex-1 px-6 lg:px-40 py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
                ...
                <div className="group flex flex-col bg-white p-8 rounded-2xl shadow-lg border border-primary/5 hover:border-gold/30 hover:translate-y-[-8px] transition-all duration-300">
                    ...
                    <div className="mb-6">
                        <div className="w-full h-48 bg-background-light rounded-xl overflow-hidden mb-6 border border-primary/5">
                            <Image
                ...
                <div className="group flex flex-col  p-8 rounded-2xl shadow-lg border border-primary/5 hover:border-gold/30 hover:translate-y-[-8px] transition-all duration-300 ">
            ...
            {/* Call to Action */}
            <div className="mt-24 rounded-3xl p-12 lg:p-16 text-center text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="bg-white/20 inline-block px-6 py-2 rounded-full text-white font-medium mb-10">
                        {t('cta.subtitle')}
                    </p>
                    <div className="flex flex-wrap justify-center gap-4">
                        <button className="bg-gold hover:bg-gold-light text-primary-dark font-bold px-10 py-4 rounded-xl transition-all shadow-xl shadow-gold/20 flex items-center gap-2">
                            <span className="material-symbols-outlined">map</span>
                            {t('cta.nearbyBranches')}
                        </button>
                        <button className="bg-white/10 hover:bg-white/20 text-white font-bold px-10 py-4 rounded-xl transition-all border border-white/20 backdrop-blur-sm flex items-center gap-2">
